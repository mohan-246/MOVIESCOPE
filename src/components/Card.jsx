    ...
    <div className="bg-slate-50">
      <div className="h-full ">
        ...
        <div className="absolute top-[5%] left-[35%] text-white font-mono font">
          <p className="font-extrabold uppercase sm:text-xl lg:text-5xl">{Movie.title}</p>
          <div className="flex xs:text-sm  sm:text-md lg:text-xl gap-3">
            <FontAwesomeIcon className="mt-4 text-red-600" icon={faHeart} />
            <p className="mt-3">
          ...
          <p className="xs:text-xs sm:text-sm md:text-md mt-3 lg:text-lg text-gray-400">"{Movie.tagline}"</p>
          <div className="xs:text-xs sm:text-sm md:text-md mt-5 lg:text-lg">{Movie.overview}</div>
        </div>
      </div>
